<div class="flex bg-neutral-primary-soft block p-3 border border-default rounded-base shadow-xs mb-8">
    <div class="p-5 flex-1">
        ...
        <div class="text-sm text-gray-400 flex gap-4">
            <div>
                Posted by <a href="{{ route('profile.show',$post->user->username)}}" class="text-gray-600 hover:underline">{{ $post->user->username }}</a> at
